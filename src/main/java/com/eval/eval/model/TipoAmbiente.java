...
public class TipoAmbiente {
    ...
    public TipoAmbiente(String nombre, String description, LocalDateTime fecha_alta, long id_usuario_alta, LocalDateTime fecha_baja, long id_usuario_baja, LocalDateTime fecha_desde, long id_usuario_desde, LocalDateTime fecha_hasta, long id_usuario_hasta) {
        this.nombre = nombre;
    ...
    public TipoAmbiente(String nombre, String description) {
        this.nombre = nombre;
        this.description = description;
    }
